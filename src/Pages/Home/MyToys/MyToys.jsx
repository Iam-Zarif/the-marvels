...
const deleteMe = (id) => {
  ...
  return (
    <>
      <div className="grid grid-cols-7 mt-20 mx-auto w-5/6">
        <h1 className="text-2xl font-semibold text-yellow-500 ">Photo</h1>

        <h1 className="text-2xl font-semibold text-yellow-500 ">
          Product name
        </h1>
        <h1 className="text-2xl font-semibold text-yellow-500 ">Category</h1>
        <h1 className="text-2xl font-semibold text-yellow-500 ">Price</h1>
        <h1 className="text-2xl font-semibold text-yellow-500 ">Ratings</h1>
      </div>
